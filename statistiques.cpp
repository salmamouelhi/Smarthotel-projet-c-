    ...
    ui(new Ui::statistiques)
{
    ...
    nuclear->moveAbove(fossil);
      ...
      query.prepare("SELECT DISTINCT numchambre FROM chambre");
      query.exec();
      ...
      while(query.next())
      {
       ...
       query1.prepare("SELECT numchambre FROM chambre where numchambre = '"+query.value(0).toString()+"' ");
       query1.exec();
       while (query1.next()) {
         fossilData.append(query1.value(0).toDouble());
       }
       query2.prepare("SELECT prix FROM chambre where numchambre = '"+query.value(0).toString()+"' ");
       query2.exec();
       while (query2.next()) {
